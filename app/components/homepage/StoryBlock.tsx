  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2">
      <div className="bg-comptoir-cream h-128 w-full relative">
        <Image
          src={
            'https://cdn.shopify.com/s/files/1/0757/4333/0629/files/aqua_motu_1.jpg?v=1714477133'
          }
          className={`object-cover absolute h-full`}
          loading="eager"
        />
      </div>
      <div className="bg-comptoir-cream h-96 md:h-128 relative order-first md:order-2">
        <div className="h-full w-full absolute z-20 flex justify-center items-center  ">
          <div className="text-center text-black">
            <div className="t-banner">{t('depan.title')}</div>
            <div className="py-4 max-w-[500px] px-4">{t('depan.text')}</div>
            <LocaleLink to={'/products/aqua-motu-intense'}>
              <button className="btn-image bg-transparent border-black text-black">
                {t('depan.btn')}
              </button>
            </LocaleLink>
          </div>
