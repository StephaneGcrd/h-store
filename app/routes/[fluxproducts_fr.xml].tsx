...
export async function loader({request, context: {storefront}}: LoaderArgs) {
  ...
  const products = metaobject?.products?.references?.edges;
  ...
  <g:link>https://www.comptoir-sud-pacifique.com/fr-fr/products/${url_end}</g:link> <g:image_link>${image_url}</g:image_link> <g:condition>new</g:condition>
